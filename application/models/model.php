...
class Model extends CI_Model {
    ...
    public function get_by_id($data)
    {
        ...
        $query['get_all_userdata']= $this->db->get('tb_login', $data);
        return $query;
    }
	...
	{
		$data = $this->db->query('select * from tb_keranjang '.$where);
		return $data;
	}

	//ambil data tabel komentar
	...
	public function GetMere($where= "")
	{
		$data = $this->db->query('select count(*) as totalmerk from tb_merk '.$where);
		return $data;
	}
