                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group">
                      <label for="">Harga</label>
                        <input type="number" class="form-control" value="" id="" name="harga" placeholder="Haraga Produk" required>                        
                    </div>
                    <div class="form-group">
                      <label for="">Jumlah</label>
                        <input type="number" class="form-control" value="" id="" name="jumlah" placeholder="Jumlah Produk" required>                        
                    </div>
                    <div class="form-group">
